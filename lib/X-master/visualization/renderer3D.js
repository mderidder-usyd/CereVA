...
X.renderer3D.prototype.update_ = function(object) {
  if (object != undefined){
    if( (object._classname == "volume" || object._classname == "mesh") || object._id == 41 || object._id == 43 || object._id == 45){
      //console.log("_update");
      //console.log(object);
    }
  }
  ...
  if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("-here");
  }
  ...
  if (goog.isDefAndNotNull(colortable) &&
    ...
    if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("--load scalars object");
    }
  ...
  if (object._children.length > 0) {
    ...
    if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("--object _children");
    }

    for (c = 0; c < numberOfChildren; c++) {

      if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
       //console.log("Updating child:" + c);
       //console.log(children[c]);
       //children[c].transform.rotateX(90);
      }
  ...
  if (existed && goog.isDefAndNotNull(texture) && texture._dirty) {
    ...
    if (goog.isDefAndNotNull(oldTexturePositionBuffer)) {
      ...
      if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
       //console.log("---testure is dirty inner 1");
      }
      ...
      if (this._context.isBuffer(oldTexturePositionBuffer._glBuffer)) {
        ...
        if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
         //console.log("----texture is dirty inner 2");
        }
  ...
  if (goog.isDefAndNotNull(texture)) {
    ...
    if (!existed || texture._dirty) {
      ...
      if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
        //console.log("--re-create gl buffers for texture");
      }
     ...
     this._texturePositionBuffers.set(id, texturePositionBuffer);
      ...
      if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
       //console.log("--use current texture");
      }
  ...
  if (existed && points._dirty) {
    ...
    if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("--points are dirty; object exists");
    }
  ...
  if (!existed || points._dirty) {
    ...
    if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("--points are dirty; object doesn't exist");
    }
  ...
  if (existed && normals._dirty) {
    ...
    if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("--normals are dirty; object exists");
    }
  ...
  if (!existed || normals._dirty) {
    ...
    if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("--normals dirty; object doesn't exist");
    }
  ...
  if (existed && colors && colors._dirty) {
    ...
    if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("--colours dirty; object exists");
    }
  }
  ...
  if (colors) {
    ...
    if (!existed || colors._dirty) {
      ...
      if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
        //console.log("--colours dirty; object doesn't exist");
      }
  ...
  if (existed && scalars && scalars._dirty) {
    ...
    if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("--scalars dirty; object exists");
    }
  }
  ...
  if (scalars) {
    ...
    if (!existed || scalars._dirty) {
      ...
      if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
       //console.log("--scalars dirty; object doesn't exist");
      }
  ...
  if (!existed) {
    ...
    if (object != undefined && (object._classname == "volume" || object._classname == "mesh")){
      //console.log("--object doesn't exist; add");
    }
  }
